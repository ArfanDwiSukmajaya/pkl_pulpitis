...
--
-- Host: localhost
-- Generation Time: May 24, 2021 at 02:30 PM
...
(1, 'Rasa Tidak Nyaman Pada Mulut'),
(2, 'Tidak Sakit Jika Tidak Mengkonsumsi Makanan'),
(3, 'Respon Nyeri Sementara Terhadap Dingin, Panas, Manis, Asam, Asin'),
(4, 'Respon Nyeri Lama Terhadap Dingin, Panas, Manis, Asam, Asin'),
(5, 'Respon Nyeri Tajam Secara Spontan'),
(6, 'Respon Nyeri Tajam Secara Berkepanjangan'),
(7, 'Rasa Nyeri Yang Lama'),
(8, 'Rasa Nyeri Berdenyut');
(9, 'Gigi Pernah Sakit');
...
--
ALTER TABLE `basis_pengetahuan`
  MODIFY `kode_pengetahuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;

--
-- AUTO_INCREMENT for table `gejala`
--
ALTER TABLE `gejala`
  MODIFY `kode_gejala` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;

--
-- AUTO_INCREMENT for table `hasil`
--
ALTER TABLE `hasil`
  MODIFY `id_hasil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
...
--
ALTER TABLE `penyakit`
  MODIFY `kode_penyakit` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;

--
-- AUTO_INCREMENT for table `post`
--
ALTER TABLE `post`
  MODIFY `kode_post` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
COMMIT;
